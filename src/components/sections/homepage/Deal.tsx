        ...
        <section className="py-4">
            <div className="container">
                <div className="bg-[url(/public/assets/collection/hero_bg_1.jpg)] bg-cover bg-center h-screen bg-fixed flex items-center">
                    ...
                    <div className="flex flex-col gap-3 bg-white rounded-md p-4 w-2xs md:w-1/2 my-auto mx-10">
                        <span className="font-bold text-gray text-sm md:text-xl">Limited Offers 20% OFF</span>
